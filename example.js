(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactTypeahead"] = factory(require("react"), require("react-dom"));
	else
		root["ReactTypeahead"] = factory(root["React"], root["ReactDOM"]);
	...
	var Typeahead = (function (_React$Component) {
	  ...
	  function Typeahead(props) {
	    ...
	    this.handleKeyup = function (e) {
	      ...
	      if (e.keyCode === 40) {
	        // going down
	        var highleghtedItemIdx = _this.state.highleghtedItemIdx;

	        if (highleghtedItemIdx === _this.state.source.length - 1) {
	          return;
	        }
	        var newIdx = null;
	        if (highleghtedItemIdx === null) {
	          newIdx = 0;
	        } else {
	          newIdx = highleghtedItemIdx + 1;
	        }
	        _this.setState({
	          highleghtedItemIdx: newIdx
	        });
	        return;
	      }
	      ...
	      if (e.keyCode === 38) {
	        ...
	        if (highleghtedItemIdx === 0 || highleghtedItemIdx === null) {
	          return;
	        }
	        _this.setState({
	          highleghtedItemIdx: highleghtedItemIdx - 1
	        });
	        return;
	      }
	      ...
	      if (e.keyCode === 13) {
	        var _ret = (function () {
	          ...
	          _this.setState({
	            ...
	            _this.props.onSelect(_this.state.source[highleghtedItemIdx]);
	          });
	          return {
	            v: undefined
	          };
	    ...
	    var fuseOptions = {
	      ...
	      distance: 100,
	      maxPatternLength: 32,
	      keys: this.props.keys || Object.keys(this.props.source[0])
	    };
	    this.fuse = new _fuseJs2['default'](this.props.source, fuseOptions); // "list" is the item array

	    this.state = {
	      source: this.props.source,
	      visible: false,
	      highleghtedItemIdx: null
	    };
	  }
	      ...
	      var listItems = this.state.source.map(function (value, idx) {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_this3.props.itemComponent, _extends({}, value, {
	            highlighted: idx === _this3.state.highleghtedItemIdx
	          }))
	        );
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcTypeahead = __webpack_require__(1);
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _srcTypeahead2['default'],
	        {
	          source: source,
	          itemComponent: function (props) {
	            return _react2['default'].createElement(
	              'div',
	              { style: { margin: 8, background: props.highlighted ? 'yellow' : 'white' } },
	              'Hello ',
	              props.name
	            );
	          },
	        ...
	        _react2['default'].createElement('input', {
	          style: { border: '2px solid #e5e5e5', borderRadius: 12, width: 200, padding: 12, outline: 'none' },
	          type: 'text',
	          onChange: function (e) {
